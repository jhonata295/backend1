...
async function buscar(nomeTarefa) {
    const resultado = await collection.findOne({nomeTarefa});
...
async function main(){
    ...
    switch (opcao) {
        ...
        await inserir (nome);
        break;}
        case '2':{const nome = readline.question("Informe o nome da tarefa:");
            await buscar(nome); 
            break;}
        case '3':{const nome = readline.question("Informe o nome da tarefa:");
            ...
            const concluidaAtual = readline.question("Informe outro situação para a tarefa:"); 
